...
func change(var left, var right):
	...
	texture_decimal_left.load("res://scenes/scoreboard/images//Giz-"+str(score_decimal_left)+".png")
	texture_unit_left.load("res://scenes/scoreboard/images//Giz-"+str(score_unit_left)+".png")
	texture_decimal_right.load("res://scenes/scoreboard/images//Giz-"+str(score_decimal_right)+".png")
	texture_unit_right.load("res://scenes/scoreboard/images//Giz-"+str(score_unit_right)+".png")
